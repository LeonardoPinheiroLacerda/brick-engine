...
To create a game, you must extend the abstract `Game` class and implement its four core abstract methods: `getPersistenceKey`, `setupGame`, `processTick`, and `processFrame`.
...
export default class MyGame extends Game {
    ...
    // 4. Persistence: Provide a unique key for LocalStorage prefixing, this key must be unique between all implemented games
