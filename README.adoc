...
* xref:docs/reference/GameState.adoc[GameState]: Tracks global game properties like `playing`, `paused`, `muted`, and `score`. Supports state persistence (e.g., saving preferences).
