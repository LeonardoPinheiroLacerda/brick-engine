...
* **Input Handling**: Unified control system supporting keyboard, on-screen action buttons, and a responsive swipe-based **Trackpad**.
...
| Tracks session score and level logic, managing persistent high scores independently.
|===
