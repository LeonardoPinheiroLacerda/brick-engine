...
| The central orchestrator. It initializes the engine, manages the main loop (ticks and frames), and coordinates transitions between game instances via an instance-based switch handler.
