...
|`topRow` |`number` |The index of the top-most row (always 0).
|`bottomRow` |`number` |The index of the bottom-most row (`height - 1`).
|`leftColumn` |`number` |The index of the left-most column (always 0).
|`rightColumn` |`number` |The index of the right-most column (`width - 1`).
|===
