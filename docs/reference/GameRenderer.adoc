...
*   **Params**:
    *   `grid`: The 2D array of cells to render.
*   **Returns**:
    *   `void`
*   **Behavior**:
    *   Iterates through the grid and draws each active cell.
...
*   **Behavior**:
    *   Values are calculated during `setup()` based on screen size.
    *   Used for aligning HUD elements and custom drawing.
*   **Example**:
