...
|`renderer` |`xref:../interfaces/Renderer.adoc[Renderer]` |An implementation of the `xref:../interfaces/Renderer.adoc[Renderer]` interface (e.g., `xref:DisplayRenderer.adoc[DisplayRenderer]`).
|===
