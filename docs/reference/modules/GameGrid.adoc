...
Read-only property returning the index of the top-most row (always 0).

**Returns**

`number` - Top row index.
...
Read-only property returning the index of the bottom-most row.

**Returns**

`number` - Bottom row index (`height - 1`).
...
Read-only property returning the index of the left-most column (always 0).

**Returns**

`number` - Left column index.
...
Read-only property returning the index of the right-most column.

**Returns**

`number` - Right column index (`width - 1`).
...
==== `isCoordinateValid(coordinate: xref:../types/Coordinate.adoc[Coordinate]): boolean`
