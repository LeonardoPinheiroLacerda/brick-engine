...
Syncs the internal state with the `xref:GameState.adoc[GameState]`. This is required for modules that implement the `xref:../interfaces/StateSyncable.adoc[StateSyncable]` interface.
